...
from sklearn.metrics import cohen_kappa_score, f1_score,accuracy_score,confusion_matrix,ConfusionMatrixDisplay, recall_score,precision_score
...
def run_models(grid_search=False,shap_flag=True,train=None,test=None):
    ...
    class_weights = {0: class_weights[0], 1: class_weights[1]}   #, 2: class_weights[2], 3: class_weights[3], 4: class_weights[4]
    ...
    if grid_search:
        ...
        models_params["RandomForestClassifier"] = {'n_estimators': [100, 200], 'max_depth': [5, 10, 15, 20, None], 'max_features': ['sqrt', None],
